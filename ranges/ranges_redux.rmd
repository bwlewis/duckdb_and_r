...
IRanges code is single-threaded and only uses one CPU core yet achieves about
10x performance beyond the DuckDB implementation in this example. No doubt
there are counter-examples to this observation in other problems, but at least
for this real-world genomics use-case, IRanges is the most efficient method for
solving the problem.
