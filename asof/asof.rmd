...
"data"), the gist is to produce an output table with dates
corresponding to the "calendar" table and values corresponding to the *most recently
known* value from the "data" table.
